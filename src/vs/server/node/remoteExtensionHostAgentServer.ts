...
class RemoteExtensionHostAgentServer extends Disposable implements IServerAPI {
	...
	constructor(
		...
		this._serverRootPath = getRemoteServerRootPath(_productService, _environmentService.args['base-path'])
		...
		this._logService.info(`Extension host agent started. (rootPath: ${this._serverRootPath})`)
	}
